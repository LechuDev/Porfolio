...
Aquí muestro mis trabajos organizados por **tecnologías**, cada uno con las tecnologias, arquitecturas y metodologias empleadas para su desarrollo.
...
- **Fase 3 – Automatización**  
  ...
  13. https://github.com/LechuDev/13.Net_flixSystem_Csharp - Sistema de recomendación básico (ejemplo: sugerir películas)  
  14. https://github.com/LechuDev/14WebScraper_Csharp - Aplicación de scraping para recolectar datos de una web pública  

- **Fase 4 – Creativos**  
   🎮 Proyectos creativos y llamativos:
  
  15.- Juego 2D simple con Unity y C#  
  16.- Simulador de zombies (pequeño prototipo que conecta con mi proyecto de mundo abierto 🧟)  
  17.- Editor de personajes básico con sliders (mini versión de UI 3D)  
