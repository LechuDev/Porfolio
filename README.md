...
- **00 – Fundamentos PHP** → bucles, funciones, arrays, CRUD básico.  
- **Aplicaciones prácticas**  
  - Sistema de Gestión Escolar  
  - Gestor de Inventario y Ventas  
  - Agenda de Contactos con Recordatorios  
- **Creativos**  
  - Sistema de Encuestas Online  
  - Mini CMS  
- **Avanzados**  
  - Laravel → E-commerce, Gestión de usuarios, Cursos online  
  - Symfony → Blog corporativo, Reservas, Gestor documental  
  - CodeIgniter, CakePHP, Yii2, Phalcon, Zend → ERP, CRM, Chat, Facturación  

---

## 🔹 Flutter / Dart

- **00 – Fundamentos Dart/Flutter** → Hello World, bucles, clases simples.  
- **Aplicaciones prácticas**  
  - Calculadora móvil  
  - Gestor de Tareas con SQLite  
  - Agenda Inteligente Flutter  
- **Creativos**  
  - Juego 2D con Flutter Flame  
  - App de Música  
- **Avanzados**  
  - Mini E-commerce con API  
  - ChatApp con Firebase  
  - Dashboard móvil con gráficas en tiempo real  
  - Arquitecturas: MVVM, Provider, Riverpod, BLoC  

---

## 🔹 Otros Lenguajes (en progreso)

- **Python** → Fundamentos + CRUD básico.  
- **Java** → Fundamentos + Gestor de tareas.  
- **Go (Golang)** → Fundamentos + API REST.  
- **TypeScript** → Fundamentos + proyectos con React/Angular.  
- **Kotlin/Android** → Fundamentos + app móvil básica.  
